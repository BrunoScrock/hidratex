/* ==========================================================================
   HIDRATEX — Funcionalidades Principais
   ========================================================================== */
...
function enviarFormulario(event) {
  ...
  if (contato) mensagem += `*Contato alternativo:* ${contato}\n`;
...
function aplicarConfiguracao() {
  ...
  if (coverageText) coverageText.textContent = CONFIG.atendimento ? "Atendimento em " + CONFIG.atendimento : "[INSERIR ÁREA DE ATENDIMENTO]";
...
function criarParticulasHero() {
  ...
  for (var i = 0; i < total; i++) {
    ...
    p.style.cssText =
      ...
      "background:" + (isRed ? "rgba(230,57,70,0.6)" : "rgba(33,150,243,0.5)") + ";" +
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Scroll do header — transparente no hero, glass ao rolar
  ...
  function aoRolar() {
    ...
    // Altura em que o hero "sai" (80% da viewport)
    var limiteGlass = hero
      ? hero.offsetTop + hero.offsetHeight * 0.65
